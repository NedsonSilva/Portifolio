...
function goToWhatsapp() {
  const contato = '5596991699136'
  const text = encodeURIComponent('Olá, vim do seu Portifólio')
  const apiUrl = `https://${mobileCheck() ? 'api' : 'web'}.whatsapp.com/send?phone=${contato}&text=${text}`;
...
copyrightEl.innerText = copyrightEl.innerText.replace('{{year}}', currentYear)